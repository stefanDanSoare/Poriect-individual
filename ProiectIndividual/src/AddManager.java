...
public class AddManager extends JFrame implements ActionListener{
	...
	public AddManager(Angajat x) {
		...
		lblNewLabel_1.setBounds(669, 6, 32, 43);
		...
		panel_6.setBounds(611, 60, 137, 42);
		...
		btnAdd.setBounds(629, 462, 101, 23);
		...
		panel_5.setBounds(611, 113, 137, 42);
		...
		panel_3.setBounds(611, 222, 137, 42);
		...
		panel_2.setBounds(611, 275, 137, 42);
		...
		panel_1.setBounds(611, 328, 137, 42);
		...
		btnBack.setBounds(58, 462, 101, 23);
		...
		panel.setBounds(611, 381, 137, 42);
		...
		panel_4.setBounds(611, 167, 137, 44);
		...
		postBox.setSelectedItem("angajat");
		postBox.setEnabled(false);
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\stefa\\OneDrive\\Desktop\\icons\\1575376469213-employee-evaluation-form.jpg"));
		lblNewLabel.setBounds(0, 0, 800, 533);
		...
		btnAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent ae){
						...
						try {
		                    ...
		                    String query = "INSERT INTO ang_info values('" + cnp + "','" + user + "','" + email + "','" + post + "','" +
		                        salariu + "','" + contact + "','" + 21 + "','" + password +"','" + manager +"')";
